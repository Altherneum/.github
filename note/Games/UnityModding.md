...
## Other ways
- [github.com/imadr/Unity-game-hacking](https://github.com/imadr/Unity-game-hacking)
...
[dnSpy](https://github.com/dnSpy/dnSpy) <br /> ![No Longer Maintained](https://github.com/Altherneum/.github/blob/main/note/assets/images/No_Longer_Maintained-red.svg?raw=true) | dnSpy is a debugger and .NET assembly editor. You can use it to edit and debug assemblies even if you don't have any source code available. <br /> **Working but you can use ``dnSpyEx`` instead.**
[MegaDumper](https://github.com/CodeCracker-Tools/MegaDumper)  <br /> ![No Longer Maintained](https://github.com/Altherneum/.github/blob/main/note/assets/images/No_Longer_Maintained-red.svg?raw=true) | Dump native and .NET assemblies.
...
[uTinyRipper](https://github.com/mafaca/UtinyRipper) <br /> ![No Longer Maintained](https://github.com/Altherneum/.github/blob/main/note/assets/images/No_Longer_Maintained-red.svg) | uTinyRipper is a tool for extracting assets from serialized files (CAB-\*, \*.assets, \*.sharedAssets, etc.) and assets bundles (\*.unity3d, \*.assetbundle, etc.?raw=true) and conveting them into native Engine format. <br /> **Use ``AssetRipper`` Instead**
[Unity Studio / AssetStudio](https://github.com/RaduMC/AssetStudio) <br /> ![No Longer Maintained](https://github.com/Altherneum/.github/blob/main/note/assets/images/No_Longer_Maintained-red.svg?raw=true) | AssetStudio is an independent tool for exploring, extracting and exporting assets.
[Unity Assets Explorer](https://zenhax.com/viewtopic.php?t=36) <br /> ![No Longer Maintained](https://github.com/Altherneum/.github/blob/main/note/assets/images/No_Longer_Maintained-red.svg) | Unity Assets Explorer is used to view the contents of Assets-files (Unity 3D engine). Allows you to: Extract all files, extract one file (from context menu), convert tex-files into a picture format DDS (on extraction?raw=true), import the changed DDS-images to the archive.
