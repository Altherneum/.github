...
- [secnumacademie.gouv.fr/](https://secnumacademie.gouv.fr/)

# Outils
- [keybase.io](https://keybase.io/)
- [trendstimecapsule.ue.r.appspot.com](https://trendstimecapsule.ue.r.appspot.com)
## Windows
- [learn.microsoft.com windows-server system-management-components](https://learn.microsoft.com/fr-fr/troubleshoot/windows-server/system-management-components/what-is-microsoft-management-console)
- [lecrabeinfo.net chiffrement-bitlocker](https://lecrabeinfo.net/chiffrement-bitlocker-cest-quoi-le-guide-ultime.html)
- [learn.microsoft.com windows-server administration server-core sconfig](https://learn.microsoft.com/fr-fr/windows-server/administration/server-core/server-core-sconfig)
- [answers.microsoft.com stop-windows-update-from-waking-up-laptop](https://answers.microsoft.com/en-us/windows/forum/all/stop-windows-update-from-waking-up-laptop/cc8a146c-1e08-4d5b-b067-bb2fd4b58e7f)
## Web
...
- [Search engine ranking](https://www.youtube.com/watch?v=Yjm6lGwqnGs)
- [shodan.io](https://www.shodan.io/)
- [live.sysinternals.com](https://live.sysinternals.com/) - [learn.microsoft.com sysinternals](https://learn.microsoft.com/fr-fr/sysinternals/)
- [learn.microsoft.com sysinternals bginfo](https://learn.microsoft.com/fr-fr/sysinternals/downloads/bginfo)
- [nmap.org](https://nmap.org/)
- [myinstants.com](https://www.myinstants.com/fr/index/fr/)
- [wikipedia.org Partition (informatique)](https://fr.wikipedia.org/wiki/Partition_(informatique))
...
- [update-help](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/update-help?view=powershell-7.4)
- [get-help](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/get-help?view=powershell-7.4)
...
- [creating-a-custom-input-box](https://learn.microsoft.com/fr-fr/powershell/scripting/samples/creating-a-custom-input-box?view=powershell-7.4)
- [get-smbshare](https://learn.microsoft.com/en-us/powershell/module/smbshare/get-smbshare?view=windowsserver2022-ps)
### Move mouse PS1
- [gist.github.com/MatthewSteeples 3616785](https://gist.github.com/MatthewSteeples/ce7114b4d3488fc49b6a?permalink_comment_id=3616785)
- [gist.github.com/MatthewSteeples 4015418](https://gist.github.com/MatthewSteeples/ce7114b4d3488fc49b6a?permalink_comment_id=4015418)
## Web code editor
...
- [developer.mozilla.org menu](https://developer.mozilla.org/fr/docs/Web/HTML/Element/menu)
- [developer.mozilla.org marquee](https://developer.mozilla.org/fr/docs/Web/HTML/Element/marquee)
- [youtube.com/ EtYtYnhxeNc  -  Tier list HTML](https://www.youtube.com/watch?v=EtYtYnhxeNc)
#### CSS
- [Pure CSS Gradient Background Animation](https://codepen.io/P1N2O/embed/pyBNzX?default-tab=result&theme-id=dark&zoom=1#result-box)
- [Particle CSS](https://codepen.io/yuanchuan/embed/ZqbVVL?default-tab=result&theme-id=dark&zoom=1#result-box)
- [Particle CSS](https://codepen.io/ampersand_xyz/embed/dXVwYB?default-tab=result&theme-id=dark&zoom=1#result-box)
- [Glitch effect CSS](https://codepen.io/chrisunderdown/pen/KzEEJQ)
- [Glitch effect CSS](https://codepen.io/cbp/pen/RaEOaj/)
- [Glitch effect CSS](https://fr.w3docs.com/tools/code-editor/5748)
- [Glitch effect CSS](https://codepen.io/RillingDev/pen/vNJoMy)
- [Background particle CSS](https://wweb.dev/resources/animated-css-background-generator)
- [github.com audiovis.js](https://github.com/CodeSpaceIndica/Javascript/blob/main/ep53_audio_visualizer/audiovis.js)
- [Infinite SVG Triangle Fusion](https://codepen.io/robdimarzo/embed/VqjvqR?default-tab=result&theme-id=dark&zoom=0.5#result-box)
...
- [Infinite SVG circle fusion](https://codepen.io/Cancepto/embed/mPYqXY?default-tab=result&theme-id=dark&zoom=0.5#result-box)
- [Glitch effect CSS](https://codepen.io/mattgrosswork/pen/VwprebG)
- [Glitch effect CSS](https://codepen.io/acupoftee/pen/WNbBxXq)
#### Light YouTube Embed
- [https://stackoverflow.com embeded-youtube-videos-slow-web-down](https://stackoverflow.com/questions/60918422/embeded-youtube-videos-slow-web-down)
- [codepen.io maghrout KqmJbQ](https://codepen.io/maghrout/pen/KqmJbQ)
## Self hosting
- [Host your own encrypted DNS](https://www.youtube.com/watch?v=pj_jyVG7sB4)
- [Console password manager](https://www.youtube.com/watch?v=FhwsfH2TpFA)
- [Linux distro alignment](https://www.youtube.com/watch?v=RigIpsYaT-o)
- [Arch install hyperland](https://www.youtube.com/watch?v=lfUWwZqzHmA)
- [Arch install hyperland²](https://www.youtube.com/watch?v=8GmpCwBqHCA)
- [cloudstack.apache.org](https://cloudstack.apache.org/)
...
- [Zoomquilt.rog](https://zoomquilt.org/) - [zoomquilt2.com](https://zoomquilt2.com/)
