...
New-VM -name $VMName -MemoryStartupBytes $RAMSize -NewVHDPath $VMPath+$VMName+".VHDX" -NewVHDSizeBytes $DiskSize -Path $VMPath+$VMName -Version 10.0 -Generation 2 -Confirm:$true -BootDevice "VHD"
# -SwitchName $Switch
