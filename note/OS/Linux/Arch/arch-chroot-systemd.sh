...
pacman -S --noconfirm systemd os-prober efibootmgr dosfstools amd-ucode
...
echo "options cryptdevice=UUID=${UUIDcrypt}:lvm:allow-discards resume=/dev/vg0/swap root=/dev/vg0/root rw quiet" >> /boot/loader/entries/arch.conf
